                                ...
                                <div class="single-item">
                                    ...
                                    <div class="single-item-body">
                                        ...
                                        <p class="single-item-price">
                                            @if($new->promotion_price == 0)
                                                <span class="flash-sale">{{number_format($new->unit_price)}} USD</span>
                                            @else
                                                <span class="flash-del">{{number_format($new->unit_price)}} USD</span>
                                                <span class="flash-sale">{{number_format($new->promotion_price)}} USD</span>
                                            @endif
                                        </p>
                                    </div>
                    ...
                    <div class="beta-products-list">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <div class="single-item">
                                    <div class="single-item-header">
                                        <a href="{{route('chitietsanpham',$sp_km->id)}}"><img src="source/image/product/{{$sp_km -> image}}" alt="" height="250px"></a>
                                    </div>
                                    <div class="single-item-body">
                                        <p class="single-item-title">{{$sp_km -> name}}</p>
                                        <p class="single-item-price">
                                            <span class="flash-del">{{number_format($sp_km -> unit_price)}} USD</span>
                                            <span class="flash-sale">{{number_format($sp_km -> promotion_price)}} USD</span>
                                        </p>
                                    </div>
                                    <div class="single-item-caption">
