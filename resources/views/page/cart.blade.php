    ...
    <div id="content">
            ...
            <form action="{{route('update_cart')}}">
                <tr class="cart_item">
                    <td class="product-name">
                        <div class="media">
                            <img class="pull-left" src="source/image/product/{{$item['attributes']['img'] }}" alt="" height="50px">
                    ...
                    <td class="product-quantity">
                        <input type="number" class="form-control quantity" name="quantity[]" value="{{$item->quantity}}" style="width:70px">
                    ...
                    <td class="product-remove">
                        <a href="{{route('xoagiohang',$item->id)}}" class="remove" title="Remove this item"><i class="fa fa-trash-o"></i></a>
                    </td>

                    <td class="product-update">
                        <button  id = "{{$item['id']}}" class="beta-btn primary update-cart"
                                name="update_cart">Update Cart <i class="fa fa-chevron-right"></i></button>
                    </td>
        ...
        <div class="cart-collaterals">
            ...
            <div class="cart-totals pull-right">
                ...
                <div class="cart-totals-row"><span>Cart total:</span> <span>{{$total}}</span></div>
